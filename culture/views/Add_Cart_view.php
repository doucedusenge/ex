        ...
        <div class="col-xl-12 col-xxl-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form method="post" action="<?=base_url()?>culture/Cart/insertionADD">
                ...
                <div class="row">
                 ...
                 <div class="col-md-12">
                  ...
                  <?php foreach ($magasinier as $value): ?>
                    <option value="<?= $value['ID_MAGASINIER']?>"><?= $value['NOM']?> </option>
                      <?php endforeach ?>
                    </select>
                         <span><?= form_error('ID_MAGASINIER') ?></span>
                    </div>
                  ...
                  <div class="col-md-12">
                    <label>Fonction <font color="red">*</font></label>
                      ...
                      <?php foreach ($fonction as $value): ?>
                        <option value="<?= $value['ID_FONCTION']?>"><?= $value['DESCR_FONCTION']?></option>
                      <?php endforeach ?>
                    </select>
  ...
  function info_cart()
    ...
    var file=new FormData();
     ...
     //alert(ID_HOBBY)
      ...
      {
        $.ajax({
          url:"<?=base_url('culture/Cart/add_in_cart')?>",
          data:file,
          type:'POST',
          contentType:false,
          processData:false,

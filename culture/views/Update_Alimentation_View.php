        ...
        <div class="row page-titles mx-0">
          <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
              <h4 style='color:#007bac'>Modification</h4>
          ...
          <div class="col-xl-12 col-xxl-12">
            <div class="card">
              ...
              <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.1/js/bootstrap-select.min.js"></script>
                  ...
                  <form method="post" action="<?=base_url()?>culture/Alimentation/update">
                  ...
                  <div class="row">
                   ...
                   <div class="col-md-6">
                    <input type="hidden" name="ID_ACHAT" value="<?=$data['ID_ACHAT']?>">
                    <label>NOM CLIENT<font color="red">*</font></label>
                      ...
                      <?php foreach ($client as $value) { if ($value['ID_CLIENT'] == $data['ID_CLIENT']) { ?>
                  ...
                  <select id="ID_PRODUIT" name="ID_PRODUIT[]"class="form-control multi-select"  multiple="multiple"  data-live-search="true">
                      ...
                      if(in_array($key['ID_PRODUIT'],$selectedproduit)) 
                      {  ?>
            ...
            <div class="col-md-6">
              ...
              <input class="form-control" type="text" name="QUANTITE" id="QUANTITE" placeholder="QUANTITE" value="<?=$data['QUANTITE']?>" value="<?=set_value('QUANTITE')?>">

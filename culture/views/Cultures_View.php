         ...
         <div class="row page-titles mx-0">
          ...
          <div class="col-sm-12 p-md-0">
            <div class="welcome-text">
             <h4 style='color:#007bac'>Listing</h4>
            </div>
          </div>
            ...
            <div class="card">
              <div class="card-body">
                <div class="table-responsive">
                  ...
                  <a class="btn btn-primary" href="<?=base_url("culture/Cultures/add")?>" >enregistrer</a>
...
<script>
  ...
  $(document).ready(function()
  {
    ...
    $("#mytable").DataTable({
      ...
      "oreder":[[ 0, 'desc' ]],
      "ajax":{
        url:"<?php echo base_url('culture/Cultures/listing/');?>",
        type:"POST", 
      },
  ...
  function get_sous_menu(id)
    {
       ...
       table=$("#mytable3").DataTable({
          ...
          "oreder":[[ 0, 'desc' ]],
          "ajax":{
            url:"<?=base_url()?>culture/Cultures/detcultures/"+id,
            type:"POST"
        },
        lengthMenu: [[10,50, 100, row_count], [10,50, 100, "All"]],
        pageLength: 10,

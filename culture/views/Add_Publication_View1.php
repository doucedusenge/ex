          ...
          <div class="col-xl-12 col-xxl-12">
            <div class="card">
              ...
              <!--      <div class="col-xl-6">
                ...
                <div class="col-xl-6">
                <label>Code publication<font color="red">*</font></label>
                <input class="form-control" type="text" name="CODE_FOURNISSEUR" id="CODE_FOURNISSEUR" placeholder="code" value="sss<?= set_value('CODE_FOURNISSEUR') ?>">
                </div> 
                   <div class="col-xl-6">
                  ...
                  <select class="form-control" name="ID_UNITE_MESURE" id="ID_UNITE_MESURE">
                    ...
                    <input class="form-control" type="text" name="QUANTITE" id="QUANTITE" placeholder="QUANTITE" <?= $value['QUANTITE']?>>

                    <label>PRIX<font color="red">*</font></label>
                    <input class="form-control" type="text" name="PRIX" id="PRIX" value="<?=set_value('PRIX')?>" placeholder="prix" >
